...
import sys
import smtplib
from email.message import EmailMessage                                   # pip install pywhatkit
import MyAlarm
...
def wish_user():
    ...
    fun_talk("I am Zeno (Python Assistant). Tell me how may I help you.")
...
if __name__ == '__main__':
    ...
    while True: 
        ...
        if 'wikipedia' in query:
            ...
            fun_talk("I am zeno (Python Assistant), developed by Dhairya Shah, Mokshit Gala, "
                        "and Riya Shah as a project in their college.")
            ...
            def send_mail(receiver, subject, message):
                ...
                server.starttls()
                server.login('mokshitgala@gmail.com', 'undo&1234')

                email = EmailMessage()
                email['From'] = 'mokshitgala@gmail.com'
                email['To'] = receiver
            ...
            email_list = {
                'Harry': 'shahdhairya51@gmail.com',
                'Alex': 'jtj123stickmoks@gmail.com',
